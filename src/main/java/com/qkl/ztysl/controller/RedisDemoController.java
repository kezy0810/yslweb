...
import com.qkl.ztysl.provider.dao.RedisDao;
...
public class RedisDemoController extends BaseAction{
	...
	public AjaxResponse redis(){
		...
		Map<String, String> jmap1 = new HashMap<String, String>();
	//  jmap1.put("taskid", "user_id|task_classno|task_type|task_name|app_name|beexcutor_url|beexcutor_name|assign_time");
		jmap1.put("7", "1|1001|点赞|抖音极速版点赞|抖音极速版|www.douyin.com/zhangsan123|张三123|2020-10-10 22:37:55");
    	jmap1.put("9", "1|1002|关注|抖音关注|抖音|www.douyin.com/zhangsan|张三|2020-10-11 13:26:45");
    	Integer userId=1;
		System.out.println(redisDaoImpl.addMap("TASK"+userId, jmap));				//存储Map
