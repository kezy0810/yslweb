...
import com.qkl.ztysl.provider.dao.AbstractBaseRedisDao;
import com.qkl.ztysl.provider.dao.RedisDao;
import com.qkl.ztysl.web.DbYmdWeb;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	public Properties getPprVue(){
		InputStream inputStream = DbYmdWeb.class.getClassLoader().getResourceAsStream("redis.properties");
